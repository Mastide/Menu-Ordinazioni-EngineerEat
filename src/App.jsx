...
export default function App() {
  ...
  if (loading) {
    return (
      <div style={{ fontFamily: "'Antonio', sans-serif", minHeight: "100vh", background: "#1c3c5e", display: "flex", alignItems: "center", justifyContent: "center" }}>
    ...
    <div style={{ fontFamily: "'Antonio', sans-serif", minHeight: "100vh", background: "url('/Sfondo.jpg') center center / cover fixed" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        input, textarea { font-family: 'Antonio', sans-serif; border: 1.5px solid rgba(255,255,255,0.25); background: rgba(255,255,255,0.07); color: #fff; padding: 10px 14px; font-size: 14px; outline: none; transition: border 0.2s; width: 100%; border-radius: 2px; }
        ...
        .script-title { font-family: 'Nickainley', cursive; font-weight: 700; color: #ffffff; }
      ...
      {showLogin && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.65)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100 }}>
          <div className="fade-in" style={{ background: "#1c3c5e", border: "1px solid rgba(255,255,255,0.15)", padding: "40px", width: 360, maxWidth: "90vw" }}>
            ...
            <p style={{ fontFamily: "'Antonio', sans-serif", fontSize: 13, color: "#7f9cb8", marginBottom: 24 }}>Area riservata</p>
            <div style={{ marginBottom: 14 }}>
              <label style={{ fontFamily: "'Antonio', sans-serif", fontSize: 11, letterSpacing: 1, color: "#9bb8d3", textTransform: "uppercase", display: "block", marginBottom: 6 }}>Email</label>
            ...
            <div style={{ marginBottom: 20 }}>
              <label style={{ fontFamily: "'Antonio', sans-serif", fontSize: 11, letterSpacing: 1, color: "#9bb8d3", textTransform: "uppercase", display: "block", marginBottom: 6 }}>Password</label>
            ...
            {loginError && <div style={{ fontFamily: "'Antonio', sans-serif", fontSize: 13, color: "#f0a0a0", marginBottom: 16 }}>{loginError}</div>}
          ...
          <div style={{ display: "flex", gap: 4, alignItems: "center" }}>
            {adminUser ? (
              <>
                ...
                <button onClick={handleLogout} style={{ marginLeft: 8, background: "transparent", border: "1px solid rgba(255,255,255,0.2)", color: "#9bb8d3", padding: "4px 12px", fontFamily: "'Antonio', sans-serif", fontSize: 11, cursor: "pointer", letterSpacing: 0.5 }}>
                  Esci
                </button>
              </>
            ) : (
              <button onClick={() => setShowLogin(true)} style={{ background: "transparent", border: "none", color: "#5b7a9a", fontFamily: "'Antonio', sans-serif", fontSize: 12, cursor: "pointer", letterSpacing: 0.5, padding: "4px 8px" }}>
                ⚙
              </button>
            )}
          </div>
      ...
      <main className="app-main" style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        {view === "client" && today && (
          <div className="fade-in">
            <div style={{ background: "rgba(192,160,80,0.12)", border: "1px solid rgba(192,160,80,0.3)", padding: "10px 18px", marginBottom: 28, textAlign: "center", fontFamily: "'Antonio', sans-serif", fontSize: 12, color: "#d8be7a" }}>
              ⏰ Ordina entro le ore 12:00 per garantirti la disponibilità dei piatti
            </div>

            <div style={{ textAlign: "center", marginBottom: 36 }}>
              <span style={{ fontFamily: "'Antonio', sans-serif", fontSize: 11, letterSpacing: 3, color: "#7f9cb8", textTransform: "uppercase" }}>
                ...
                .map((c) => {
                  ...
                  return (
                    <div key={c.itemsKey} className="card" style={{ padding: "20px 24px" }}>
                      <div style={{ fontSize: 10, fontFamily: "'Antonio', sans-serif", fontWeight: 600, letterSpacing: 2, color: "#7f9cb8", textTransform: "uppercase", marginBottom: 10 }}>{c.label}</div>
                      {avail.length === 0 ? (
                        <div style={{ fontFamily: "'Antonio', sans-serif", fontSize: 13, color: "#b08080", fontStyle: "italic" }}>Non disponibile</div>
                      ) : (
                        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                          {avail.map((it) => (
                            <div key={it.nome} style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: 10 }}>
                              <span style={{ fontFamily: "'Antonio', sans-serif", fontSize: 15, fontWeight: 500, color: "#fff" }}>{it.nome}</span>
                              <span style={{ fontFamily: "'Antonio', sans-serif", fontSize: 13, color: "#9bb8d3", whiteSpace: "nowrap" }}>{formatPrice(it.prezzo)}</span>
                            </div>
                          ))}
                        </div>
                      )}
                  ...
                  .map((c) => {
                    ...
                    return (
                      <div key={c.itemsKey} className="card" style={{ padding: "14px 16px" }}>
                        <div style={{ fontSize: 10, fontFamily: "'Antonio', sans-serif", letterSpacing: 1.5, color: "#7f9cb8", textTransform: "uppercase", marginBottom: 6 }}>{c.label}</div>
                        {avail.length === 0 ? (
                          <div style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, color: "#b08080", fontStyle: "italic" }}>Non disponibile</div>
                        ) : (
                          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                            {avail.map((it) => (
                              <div key={it.nome} style={{ display: "flex", justifyContent: "space-between", gap: 6 }}>
                                <span style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, fontWeight: 500, color: "#fff" }}>{it.nome}</span>
                                <span style={{ fontFamily: "'Antonio', sans-serif", fontSize: 11, color: "#9bb8d3", whiteSpace: "nowrap" }}>{formatPrice(it.prezzo)}</span>
                              </div>
                            ))}
                          </div>
                        )}
            ...
            {suspended ? (
              <div style={{ background: "rgba(180,70,70,0.15)", border: "1px solid rgba(180,70,70,0.3)", padding: "16px 20px", fontFamily: "'Antonio', sans-serif", fontSize: 14, color: "#f0a0a0", textAlign: "center" }}>
                Le ordinazioni sono temporaneamente sospese. Riprova più tardi.
              </div>
            ) : orderSent ? (
              <div className="fade-in" style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.2)", padding: "24px", fontFamily: "'Antonio', sans-serif", textAlign: "center" }}>
              ...
              <div className="card order-card-padding" style={{ padding: "28px 32px", marginTop: 16 }}>
                <div style={{ marginBottom: 16 }}>
                  <label style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, letterSpacing: 1, color: "#9bb8d3", textTransform: "uppercase", display: "block", marginBottom: 6 }}>Nome e cognome *</label>
                  ...
                  {nameAlreadyOrderedToday && (
                    <div style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, color: "#d8be7a", marginTop: 6 }}>
                      ⚠ Risulta già un ordine oggi con questo nome. Se procedi, verrà aggiunto un secondo ordine.
                    </div>
                  )}
                </div>
                <div style={{ marginBottom: 16 }}>
                  <label style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, letterSpacing: 1, color: "#9bb8d3", textTransform: "uppercase", display: "block", marginBottom: 12 }}>Selezione *</label>
                  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    {categories
                      ...
                      .map((c) => {
                        ...
                        return (
                          <div key={c.itemsKey}>
                            <div style={{ fontFamily: "'Antonio', sans-serif", fontSize: 11, letterSpacing: 1.5, color: "#7f9cb8", textTransform: "uppercase", marginBottom: 8 }}>{c.label}</div>
                            {locked && (
                              <div style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, color: "#7f9cb8", fontStyle: "italic", marginBottom: 8 }}>Seleziona un secondo per poter scegliere il contorno</div>
                            )}
                              ...
                              {avail.map((it) => {
                                ...
                                return (
                                  <div
                                    ...
                                    style={{ display: "flex", alignItems: "center", justifyContent: "space-between", cursor: locked ? "not-allowed" : "pointer", fontFamily: "'Antonio', sans-serif", fontSize: 14, opacity: locked ? 0.4 : 1 }}
                                  >
                ...
                {orderForm.selectedItems.length > 0 && (
                  <div style={{ display: "flex", justifyContent: "space-between", padding: "10px 0", borderTop: "1px solid rgba(255,255,255,0.15)", marginBottom: 16, fontFamily: "'Antonio', sans-serif" }}>
                ...
                <div style={{ marginBottom: 22 }}>
                  <label style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, letterSpacing: 1, color: "#9bb8d3", textTransform: "uppercase", display: "block", marginBottom: 6 }}>Note (facoltativo)</label>
                ...
                <div style={{ fontFamily: "'Antonio', sans-serif", fontSize: 11, color: "#7f9cb8", marginBottom: 14, fontStyle: "italic" }}>
                  Ricorda: ordina entro le ore 12:00 per garantirti la disponibilità.
                </div>
                {orderError && (
                  <div style={{ background: "rgba(180,70,70,0.15)", border: "1px solid rgba(180,70,70,0.3)", padding: "12px 16px", marginBottom: 14, fontFamily: "'Antonio', sans-serif", fontSize: 13, color: "#f0a0a0" }}>
                    Qualcosa è andato storto durante l'invio. Controlla la connessione e riprova.
                  </div>
                )}
                <button className="btn-primary" onClick={handleOrder} disabled={submitting}>
                  {submitting ? "Invio in corso..." : orderError ? "Riprova" : "Invia prenotazione"}
                </button>
              </div>
            )}
          </div>
          ...
          <div className="fade-in">
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 28 }}>
              <div>
                ...
                <p style={{ fontFamily: "'Antonio', sans-serif", fontSize: 13, color: "#7f9cb8", marginTop: 4 }}>{orders.length} ordini ricevuti</p>
              </div>
              <button onClick={toggleSuspended} style={{ padding: "10px 22px", fontFamily: "'Antonio', sans-serif", fontSize: 13, fontWeight: 500, cursor: "pointer", border: "none", background: suspended ? "rgba(80,150,80,0.85)" : "rgba(180,70,70,0.85)", color: "white", letterSpacing: 0.5, transition: "all 0.2s", borderRadius: 2 }}>
            ...
            {(() => {
              ...
              return (
                <div className="card" style={{ padding: "18px 22px", marginBottom: 24 }}>
                  <div style={{ fontFamily: "'Antonio', sans-serif", fontSize: 11, fontWeight: 600, letterSpacing: 1.5, color: "#9bb8d3", textTransform: "uppercase", marginBottom: 12 }}>Riepilogo per la cucina — oggi</div>
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: "6px 18px" }}>
                    {tallyList.map((t, idx) => (
                      <div key={idx} style={{ display: "flex", justifyContent: "space-between", fontFamily: "'Antonio', sans-serif", fontSize: 13, color: "#fff", padding: "3px 0" }}>
            ...
            {orders.length === 0 ? (
              <div className="card" style={{ padding: "24px", fontFamily: "'Antonio', sans-serif", color: "#7f9cb8", fontSize: 14 }}>Nessun ordine ancora.</div>
            ) : (
              orders.map((o) => {
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                      <div style={{ flex: 1 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
                          <span style={{ fontFamily: "'Antonio', sans-serif", fontWeight: 600, fontSize: 15, color: "#fff" }}>{o.name}</span>
                          <span style={{ fontFamily: "'Antonio', sans-serif", fontSize: 11, color: "#7f9cb8" }}>
                            {new Date(o.created_at).toLocaleTimeString("it-IT", { hour: "2-digit", minute: "2-digit" })}
                          </span>
                          {o.selected_items && o.selected_items.length > 0 && (
                            <span style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, color: "#9bb8d3", marginLeft: "auto" }}>{formatPrice(orderTot)}</span>
                          )}
                        </div>
                        ...
                        {o.note && <div style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, color: "#7f9cb8", fontStyle: "italic" }}>"{o.note}"</div>}
                      </div>
            ...
            <p style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, color: "#7f9cb8", marginBottom: 16 }}>Aggiungi quanti piatti vuoi per ogni categoria, con prezzo, e segnali come non disponibili o eliminali.</p>
            ...
            {menu.map((day) => {
              ...
              <div key={day.id} className="card" style={{ padding: "18px 20px", marginBottom: 14, borderLeft: `3px solid ${day.is_today ? "#fff" : "rgba(255,255,255,0.2)"}` }}>
                {editingDay === day.id ? (
                  <div style={{ marginBottom: 16 }}>
                    <div style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, fontWeight: 600, marginBottom: 12, color: "#fff" }}>Modifica giorno</div>
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 10, marginBottom: 10 }}>
                      <div>
                        <label style={{ fontFamily: "'Antonio', sans-serif", fontSize: 11, color: "#9bb8d3", display: "block", marginBottom: 4 }}>Giorno</label>
                        <input value={editForm.day || ""} onChange={(e) => setEditForm((f) => ({ ...f, day: e.target.value }))} />
                      </div>
                      <div>
                        <label style={{ fontFamily: "'Antonio', sans-serif", fontSize: 11, color: "#9bb8d3", display: "block", marginBottom: 4 }}>Data</label>
                  ...
                  <div onClick={() => toggleDayExpanded(day.id)} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: expanded ? 16 : 0, cursor: "pointer" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                      <span style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, color: "#7f9cb8", display: "inline-block", transform: expanded ? "rotate(90deg)" : "rotate(0deg)", transition: "transform 0.2s" }}>▶</span>
                      <span style={{ fontFamily: "'Antonio', sans-serif", fontWeight: 600, fontSize: 16, color: "#fff" }}>{day.day} {day.date}</span>
                      {day.is_today && <span className="tag" style={{ background: "rgba(255,255,255,0.9)", color: "#1c3c5e", fontSize: 10 }}>Oggi</span>}
                      {!expanded && (
                        <span style={{ fontFamily: "'Antonio', sans-serif", fontSize: 11, color: "#5b7a9a" }}>{totalItems} {totalItems === 1 ? "piatto" : "piatti"}</span>
                      )}
                    </div>
                    ...
                    return (
                      <div key={c.itemsKey} style={{ background: "rgba(255,255,255,0.03)", padding: "12px 14px", opacity: isHidden ? 0.5 : 1 }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                          <span style={{ fontFamily: "'Antonio', sans-serif", fontSize: 11, fontWeight: 600, color: "#9bb8d3", textTransform: "uppercase", letterSpacing: 1 }}>{c.label}</span>
                          <button onClick={() => toggleCategoryHidden(day.id, c.hideKey, day.hidden_fields)} style={{ background: "transparent", border: "none", color: isHidden ? "#8fcf9f" : "#e09a9a", fontFamily: "'Antonio', sans-serif", fontSize: 10, cursor: "pointer", letterSpacing: 0.5 }}>
                            {isHidden ? "Mostra categoria" : "Nascondi categoria"}
                          </button>
                        </div>

                        {items.length === 0 && (
                          <div style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, color: "#5b7a9a", fontStyle: "italic", marginBottom: 8 }}>Nessun piatto inserito</div>
                        )}
                          ...
                          return isEditingThis ? (
                            <div key={idx} className="item-row" style={{ flexWrap: "wrap", gap: 6 }}>
                              <input
                                ...
                                autoFocus
                              />
                              <span style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, color: "#7f9cb8" }}>€</span>
                              <input
                            ...
                            <div key={idx} className="item-row">
                              <span style={{ fontFamily: "'Antonio', sans-serif", fontSize: 13, color: it.unavailable ? "#6b7d8e" : "#fff", textDecoration: it.unavailable ? "line-through" : "none", flex: 1 }}>
                                {it.nome}
                              </span>
                              <span style={{ fontFamily: "'Antonio', sans-serif", fontSize: 12, color: "#7f9cb8" }}>€</span>
                              <input
